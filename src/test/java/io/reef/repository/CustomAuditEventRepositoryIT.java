package io.reef.repository;

import io.reef.AreteApp;

import io.reef.RedisTestContainerExtension;
import io.reef.config.Constants;
import io.reef.config.TestSecurityConfiguration;
import io.reef.config.audit.AuditEventConverter;
import io.reef.domain.PersistentAuditEvent;
...
import static io.reef.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
